...
//		hot.setGrade("3");
//		hot.setHotelAddress("����У��");
//		hot.setHotelDiscription("�Ƶ�����������õľƵ�");
//		hot.setHotelName("������û���־Ƶ�");
//		hot.setHotelStrict("�Ͼ�");
//		hot.setHotelStaffId("151250170");
//		HotelPO hot1 = new HotelPO();
//		hot1.setHotelId("12345");
//		hot1.setGrade("3");
//		hot1.setHotelAddress("����У��");
//		hot1.setHotelDiscription("�Ƶ�����������õľƵ�");
//		hot1.setHotelName("������û���־Ƶ�");
//		hot1.setHotelStrict("�Ͼ�");
//		hot1.setHotelStaffId("151250170");
//		HotelPO hot2 = new HotelPO();
//		hot2.setHotelId("1234567");
//		hot2.setGrade("3");
//		hot2.setHotelAddress("����У��");
//		hot2.setHotelDiscription("�Ƶ�����������õľƵ�");
//		hot2.setHotelName("������û���־Ƶ�");
//		hot2.setHotelStrict("�Ͼ�");
//		hot2.setHotelStaffId("151250170");
//		HotelPO hot3 = new HotelPO();
//		hot3.setHotelId("1234");
//		hot3.setGrade("3");
//		hot3.setHotelAddress("����У��");
//		hot3.setHotelDiscription("�Ƶ�����������õľƵ�");
//		hot3.setHotelName("������û���־Ƶ�");
//		hot3.setHotelStrict("�Ͼ�");
