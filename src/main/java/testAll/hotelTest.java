...
//		HotelPO hotel = new HotelPO("1121234","213213", "nanjing", "�����Ƶ�");
...
//		HotelPO hotel = new HotelPO("1121234","213213", "nanjing","Բͨ��Ƶ�");
//		hotelDataService.update(hotel);
//	}
//	@Test
//	public void test004Del()throws Exception{
//		HotelPO hotel = new HotelPO("112123","213213", "nanjing", "�����Ƶ�");
